...
# 포지션 미보유 자산의 평균 진입가를 표현하는 의미 상수.
# 0.0 자체는 "유효한 평균가" 로 해석되지 않으며, 보유량(``actual_shares`` 등)이
# 0 일 때만 사용된다 (drift / balance_adjust / daily_runner 공용).
EMPTY_POSITION_AVG_PRICE: Final[float] = 0.0
