...
class ChartTheme:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        line_style_map = {"solid": 0, "dotted": 1, "dashed": 2, "large_dashed": 3, "sparse_dotted": 4}
        return {
            "layout": {
            ...
            "grid": {
                "vertLines": {"color": self.grid_vert_color, "visible": self.grid_lines_visible},
                "horzLines": {"color": self.grid_horz_color, "visible": self.grid_lines_visible},
            },
            "titleOptions": {
