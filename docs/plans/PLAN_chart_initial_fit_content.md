...
- [x] 대시보드 차트 초기 로드 시 전체 데이터가 보이도록 fitContent 활성화
- [x] 기존 scroll_padding=60 (앞뒤 2~3개월 여유) 스크롤 제한 조건 유지
...
- [x] 차트 초기 로드 시 전체 데이터가 fitContent로 표시됨
- [x] scroll_padding=60 스크롤 제한 조건 유지됨
...
- [x] `DEFAULT_ZOOM_LEVEL = 200`을 충분히 큰 값으로 변경하여 fitContent 폴백 활성화
- [x] 주석 업데이트: fitContent 동작 원리 설명
...
- 2026-02-20 18:05: 구현 완료 + 검증 통과 (passed=301, failed=0, skipped=0)
